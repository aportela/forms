const vueFormsSearchDateField = (function () {
    "use strict";
    ...
    let template = function () {
        return `
            <div class="field has-addons">
                ...
                <div class="control">
                    <a class="button" v-bind:disabled="disabled" v-on:click.prevent="$emit('searchTriggered', dates)">
                        <span class="icon">
    ...
    let module = Vue.component('f-search-date-field', {
        template: template(),
        data: function () {
            return ({
                selected: 0,
