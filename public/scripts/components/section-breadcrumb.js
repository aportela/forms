    ...
    let template = function () {
        return `
            <nav class="breadcrumb has-bullet-separator" aria-label="breadcrumbs">
                ...
                <li v-if="isRouteActive('updateUser')" aria-current="page"><a href="#"><span class="icon is-small"><i class="fas fa-user-cog" aria-hidden="true"></i></span><span>Update user</span></a></li>
                </ul>
            </nav>
        `;
    };
